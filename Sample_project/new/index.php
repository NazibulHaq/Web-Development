				...
				<td>
					...
					<td>
						<a href="#editEmployeeModal" class="edit" data-toggle="modal">
							...
							data-doctors_name="<?php echo $row["doctors_name"]; ?>"
							data-appointment_date="<?php echo $row["appointment_date"]; ?>"
							data-appointment_time="<?php echo $row["appointment_time"]; ?>"
							title="Edit"></i>
						</a>
				...
				<form id="user_form">
					...
					<div class="modal-body">					
						...
						<div class="form-group">
							...
							<input type="text" id="appointment_time" name="appointment_time" class="form-control" required>
						</div>					
					</div>
			...
			<div class="modal-content">
				<form id="update_form">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label>Doctor Name </label>
							<input type="text" id="doctors_name_u" name="doctors_name" class="form-control" required>
						</div>
						<div class="form-group">
							<label>Appointment Date</label>
							<input type="date" id="appointment_date_u" name="appointment_date" class="form-control" required>
						</div>
						<div class="form-group">
							<label>Appointment Time</label>
							<input type="time" id="appointment_time_u" name="appointment_time" class="form-control" required>
						</div>					
					</div>
					<div class="modal-footer">
